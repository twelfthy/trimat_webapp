...
writer = SummaryWriter('/Users/oliviergianoli/Desktop/Project TriMax/Codes/python/copy/runs')
...
def main():
    ...
    dataset = Points_Dataset('/Users/oliviergianoli/Desktop/Project TriMax/Codes/python/copy/trainset', get_transform(train=True))
    dataset_validation = Points_Dataset('/Users/oliviergianoli/Desktop/Project TriMax/Codes/python/copy/testset', get_transform(train=False))
    ...
    for epoch in range(num_epochs):
        ...
        train_one_epoch(model, optimizer, data_loader_validation, data_loader_validation, device, loss_vector, val_loss_vector, epoch, print_freq=5)
        
        # print(loss_vector[passes])
        writer.add_scalars("losses2",
                            {'training loss': loss_vector[epoch],
                            'validation loss': val_loss_vector[epoch]},
                            epoch)
        plt.scatter(epoch, loss_vector[epoch], color='red', s=100, marker='s')
    ...
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.savefig('/Users/oliviergianoli/Desktop/Project TriMax/Codes/python/copy/PLOTS/plot.jpg')

    print("That's it for training. Now lets test. \n")

    torch.save(model.state_dict(), '/Users/oliviergianoli/Desktop/Project TriMax/Codes/python/copy/model_weights.pth')
